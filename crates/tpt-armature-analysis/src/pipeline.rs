...
use tpt_armature_formats::{parse, MemoryMap};
use tpt_armature_ir::{recover_functions, Instruction, Module};
...
impl Analysis {
    ...
    pub fn code_section(&self) -> Option<&tpt_armature_formats::Section> {
