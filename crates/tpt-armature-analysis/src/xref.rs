...
use tpt_armature_formats::Export;
use tpt_armature_ir::{Instruction, Operand};
...
pub fn build_xrefs_for_module(module: &tpt_armature_ir::Module, symbols: &[Export]) -> XrefIndex {
